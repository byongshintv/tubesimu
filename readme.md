...
# **1. 대의명분**
앞으로의 비트튜브를 대신할 시뮬레이터를 만들겠다고 해도 무엇을 위해서, 어떻게, 정말 가능한지 등의 근거가 없으면 허울만 근사한 빈 껍질에 불과합니다. 

이 프로젝트에 기대를 걸고있는 다른 기존 비트튜브 플레이어를 위해서, 생각의 정리가 필요한 나 자신을 위해서 작성한 문단입니다.


## **1-1. 요구사항의 확정**
하나의 곡으로 여러 사람들이 다른 채보를 만들고, 누군가가 만든 채보에 대해 평가를 남기고, 자신이 좋아하는 곡으로 게임을 즐기고 싶은 사람은 아직 많이 있습니다. 약 5년 반이라는 길다면 길고 짧다면 짧은 서비스 기간동안, 사람들은 자신들이 만든 채보를 통해 사람들과의 커뮤니케이션을 이어왔습니다. 이런 교류의 장을 잃고 싶어 하지 않은 사람은 아직 많습니다. 저 또한 그렇습니다.

## **1-2. 요소기술의 확정**
모든 서비스를 구현하는데 
## **1-3. 구현 가능성의 확정**
가장 까다롭고 다루기 거북하지만 그만큼 짚고 넘어가지 않으면 안되는 문제입니다. 중점적으로 살펴보아야 하는 사안은 다음과 같습니다.

 ## 1-3-1. 웹에서 게임 플레이를 구현하여도 기술적인 문제가 없는가
없습니다.

## 1-3-2. 이정도 규모의 프로젝트를 나 혼자서도 진행할 수 있는가
있습니다.

## 1-3-3. 비트튜브 제작사에서 회사에서 이런 서비스를 허가 해 줄까?
주식회사 technon에 이메일로 물어본 결과 공식 소스만 도용하지 않으면 ok라고 합니다.

## 1-3-4. 비트튜브 서비스 종료원인의 제1원인에 해당하는 유튜브의 규제 강화를 타개할 수 있는가?
있습니다,
